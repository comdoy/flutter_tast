...
class JobInstallPage extends StatefulWidget {
  const JobInstallPage({Key? key}) : super(key: key);

  @override
  State<JobInstallPage> createState() => _JobInstallPageState();
}

class _JobInstallPageState extends State<JobInstallPage> {
  bool isLogin = false;
  ...
  _getUserinfo() async {
    ...
    setState(() {
      ...
      if (userInfo["recruiteraccount"] != null) {
        phone = userInfo["recruiteraccount"];
      }
    });
  }
        ...
        child: ListView(
          ...
          children: [
            ...
            textFormItme(
              ...
              '修改密码',
              onTap: () {
                Application.router.navigateTo(context, '/job_edit');
              },
            ),
            textFormItme(
              Icons.recent_actors,
