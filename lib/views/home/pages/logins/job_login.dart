...
class JobLogin extends StatefulWidget {
  ...
  @override
  _JobLoginState createState() => _JobLoginState();
}
            ...
            child: Row(
              children: [
                ...
                btnFlatButtonWidget(
                  ...
                  width: 147,
                  onPressed: () async {
                    var res = await Navigator.pushNamed(context, '/job_enroll');
                    if (res is Map) {
                      _emailController.text = res['jobusername'];
                      username = res['jobusername'];
                      _passController.text = res['jobpassword'];
                      password = res['jobpassword'];
                      setState(() {});
                    }
                  },
